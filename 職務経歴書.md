  ...
  - 部署：ブラウザプラットフォーム部キャンペーンチーム
    - <u>案件「内部広告最適化」2023/01〜2023/04, 2023/11〜現在</u>
      - 業務内容
        ...
        - TOP画面 (一般/R18 両方)
        [https://games.dmm.com/](TOPビックポップアップ)
        <img src="images/resume_dmm_games_product_1-1.png" alt="DMM GAMESトップページバナー" width="400">

        - マイページ画面 (一般/R18 両方)
        [https://library.games.dmm.com/](マイゲーム)
        <img src="images/resume_dmm_games_product_1-2.png" alt="DMM GAMES マイゲームバナー" width="400">

        - 実行画面ブラウザプレイヤー画面(一般/R18 両方)
        <img src="images/resume_dmm_games_product_1-3.png" alt="DMM GAMES テキスト訴求" width="400">

      - 技術スタック

        Golang、Go Echo、Python、React、TypeScript、GraphQL、Next.JS、Kubernetes、Locust、AWS DynamoDB、ALB、Github Actions
    ...
    - <u>案件「デイリーミッションポイント即時付与機能開発」2023/10 ~ 2023/11</u>
      ...
      - 技術スタック
        ...
        Python、Circle CI、AWS ALB、Lambda、DynamoDB、EventBridge
    ...
    - <u>案件「ステップアップポイントバック機能開発」2022/11 ~ 2022/12</u>
      ...
      - 技術スタック
        ...
        PHP、Laravel、Python、JavaScript、Circle CI、AWS ALB、Lambda、MySQL、AWS Linux2
