...
- Web エンジニア（2019/05〜現在）4 年 9 ヶ月
  - 自社開発 1 年 3 ヶ月（2022/11〜現在）
    - 設計（DB 設計、アーキテクチャー設計、ソフトウェア設計）
    - 開発
    - テスト（単体／結合/総合）
    - 運用・保守
    - 技術選定
  - 受託開発 1 年 9 ヶ月（2021/01〜2022/09）
    - 設計（DB 設計、アーキテクチャー設計、ソフトウェア設計）
    - 開発
    - テスト（単体／結合/総合）
    - 運用・保守
    - 技術選定
    - タスク管理
  - 自社開発 1 年 7 ヶ月 （2019/05〜2020/12）
    - 設計（DB 設計、ソフトウェア設計）
    - 開発
    - テスト（単体／結合）
    - 運用・保守
    - 技術選定
- プリセールス SE／ネットワークエンジニア （2018/02〜2019/05）1 年 3 ヶ月
  - 提案（顧客折衝）
  - ネットワーク設計（基本/詳細）
  - オンプレ環境構築
  - ネットワーク導入
...
- システムインテグレーター （2016/12〜2018/01）1 年 2 ヶ月
  - サーバ保守
  - サーバ設計（基本/詳細）
  ...
  - 部署：ブラウザプラットフォーム部キャンペーンチーム
    - <u>案件「内部広告最適化」2023/01〜2023/04, 2023/11〜現在</u>
      - 業務内容
        ...
        DMM GAMESのキャンペーンチーム使用している内部広告枠の最適化を担当。効果測定目的で使用している。

        元々は悪しき文化により、ユーザの属性やバナー表示条件などがハードコーディングされていた部分をDB化したり、コードをマイクロサービス上で動かせるように提案から設計、実装、負荷試験、リリースまですべて1人で担当。

        - TOP画面 （一般/R18 両方）<br />
        [https://games.dmm.com/](https://games.dmm.com/)<br />
          <img src="https://lh3.googleusercontent.com/fife/AGXqzDnEpPL0ccmVU3e9WQRpQCwmuiFniSHk7VpKNk04jGZi9_5DGR-IsZUZPP41G8lpsCVQOZdLzBm81XzuTSNoWSfQewtXPNdmpwHGCWmqZv3fOvRXAgYp5UoO8wG_0PQ0W0vX6SomR6eORFhC6CnyKz8qbmMeleAkRHcFdfRjY7SOBpGJbZbgiRAEgWF4FrE9tfveQDyjQIkBY6BFW1HLA57r5hBx8dWaC15Xi4WrCYg6Y-RwuvxtryCql91NUUJTaQmhhEhDhXyJTSme0Ga2KNkWcKlQS5i3imzKJU18LIv9AhOl3QZevT_4B-sN32KEqHQS64nq4fdmcPynpOsIa-iPpEB7Hxxcu5OprpqILpcI1O7fhD_6WxwYJ8xqkqwC1HTf288DyC1SjQpkX9BaSsLiStnfIOnwROWe_LEnb9r_wk5tdLPJXgeeusip0ZgQC-1eynmUaOD-nHOr-winkFlYgu8htfbF7OJB5Jl1H1VIr49lf63MHhCFy9n_95agPhLZa3rsQ_TIzsBRv7ysoYLmAPNXyX4EAcFNtAyzSgiZT8reXL67AoGoAxLFl1ymTNhFw0SYAotdfZdbB2d8E2Fcgd5MtCq4tgn48SYX9vR6DyFnU5qG-lgDYUS42KTaKRJhPVSkLapO3Tr2B95Oxe1zXKM2ZhXeVxbczugsfZ-XT1Be6btabIFMb4yEzVrqx2qBX33C7jt6csUCnISIsk0zYY6fMzZa4lb9h9yZvmW2BWflX8Xui51sEV4-Kpvx-m09e2AdLWeZfXrKADvgc25vgs4uE5IdnlW53QizLmMWdUkWfYP8wYkGe7ri6wZepUyZ8H7HHw4czcgICNNr2w6Av1rv6sHPGA5-1_IYunOJWsP27kNWtkTzAZc69_eX_DBC9RFA3pv2ItEEToSYtW66E7GxjCn1SHvkxvHvQRXnQyWq1punGmZ6Gws2571UXw80FRsPSchXZ2w_14f4eFHboUxfwBJCIaGl1eBDOxmI5j-pvMBl190ZGZ_uCqiPX80nHl0YOQhIvXEnbcyhZh5DcZd0kn4sHCnZXX6hBt9wicNmwX0iIQXRga52dLG5n-boUYsp0rBcdaN86wPgS-dQhsiTlI8dVDd-HxsDqPS9Aig_tmxHSYNLgkbOXjZY1KB7jS4HUdYEilXeY8jyA8N_MKwsgvLDbMvB6gCn04pytam_KAiYdgacfbkdexVHz4WLT5zSm5kqZC__Rw259e7wl_nxinDBwZI5YuawWDYaF6WMIR2C3wLxIJq188y3-s7qPlDKeoOzJyZz-rhHs3ON2WD2t8S-SVpQo3tcR3YpMGDDyLZLqzcAo6rVU0cpW6bTUjvVw9XvX3xVTgYoj3xMvp4NrdDEApPK47fbSwSySg4_GZ6GKEx2GGPUIPm11nAzT7h--aXDEej181xk5cT5I69i_MG6QZLclnB5T2N24B6mkWuok_Dxv21A1TZivv_utYivG1dW_vZoPhQ125IwiGKH13VPTxF2PHA9H2yKeGkUJjjq0VvtwQ=w2880-h1508" alt="DMM GAMESトップページバナー" width="600">
        <br />
        <br />

        - マイページ画面 （一般/R18 両方）<br />
        [https://library.games.dmm.com/](https://library.games.dmm.com/)<br />
          <img src="images/resume_dmm_games_product_1-2.png" alt="DMM GAMES マイゲームバナー" width="600">
        <br />
        <br />

        - 実行画面ブラウザプレイヤー画面（一般/R18 両方）<br />
          <img src="images/resume_dmm_games_product_1-3.png" alt="DMM GAMES テキスト訴求" width="600">
        <br />
        <br />
      - 技術スタック
    ...
    - <u>案件「デイリーミッションポイント即時付与機能開発」2023/10 〜 2023/11</u>
      - 業務内容
        ...
        DMM GAMESの横断的に実施しているシーズンデイリーボーナスのポイント付与をこれまでは、後付与していたポイントをミッション達成後に非同期で自動的にポイントが付与されるようにLambdaを実装。
